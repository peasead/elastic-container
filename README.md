...
Requirements are minimal: \*NIX or macOS, [Docker](https://docs.docker.com/get-docker/), [jq](https://stedolan.github.io/jq/download/), [git], and [Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git).
